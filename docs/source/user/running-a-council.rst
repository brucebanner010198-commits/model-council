...
* **Center stage** — a tile for each model plus your own "You" tile. The currently
  speaking model glows and shows a live waveform; a "thinking…" state appears while it
  composes a reply.
* **Transcript** (top-right) — every turn, labelled with the speaker's name and colour.
* **Scribe's Notes** (bottom-right) — key points captured automatically.
...
.. list-table::
   ...
   * - **Open the floor**
     - Lets the models open the discussion themselves — great to kick things off.
   * - **Round table**
   ...
   * - **Export PDF**
     - Download transcript + notes + standings + verdict.
   * - **voices on/off**
...
directly (e.g. tap Claude for a coding question).

Personas (optional)
-------------------

By default each model uses its natural personality. In **Settings** you can give any
member a persona (e.g. *"a fierce open-source advocate"*) to shape how it argues.
